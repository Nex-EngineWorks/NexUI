...
{
    /// <summary>UI Toolkit implementation of <see cref="INXButton"/> over an element handle.</summary>
    public sealed class NXButtonUIToolkit : INXButton
    {
        ...
        public NXButtonUIToolkit(IUIElementHandle handle)
        {
            Handle = handle;
            ...
            if (_click == null)
                UnityEngine.Debug.LogWarning($"[NexUI] NXButtonUIToolkit: '{handle?.Id}' has no click capability.");
        }
    }
}
